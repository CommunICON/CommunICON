...
public class CanvasView extends View {
    ...
    private int paintFillColor     = Color.GREEN;
    ...
    public void setColor(int brg){
        switch (brg){
            case 1:
                this.paintStrokeColor = Color.BLACK;
                this.paintStrokeWidth = 10F;
                break;
            case 2:
                this.paintStrokeColor = Color.GREEN;
                this.paintStrokeWidth = 10F;
                break;
            case 3:
                this.paintStrokeColor = Color.RED;
                this.paintStrokeWidth = 10F;
                break;
        }
    }
    ...
    public void erase(){
        this.paintStrokeColor = Color.WHITE;
        this.paintStrokeWidth = 60F;
    }
